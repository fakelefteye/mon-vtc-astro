...
    port: parseInt(import.meta.env.EMAIL_PORT, 10), // Assurez-vous que le port est un nombre entier (base 10)
    secure: import.meta.env.EMAIL_SECURE === 'true', // DOIT ÊTRE UN BOOLÉEN. 'true' pour 465, 'false' pour 587.
                                                 // Basé sur votre erreur précédente (wrong version number), 
                                                 // le serveur attendait très probablement secure: true sur 465.
    auth: {
        user: import.meta.env.EMAIL_USER,
        pass: import.meta.env.EMAIL_PASSWORD,
    },
    tls: {
        // Cette option peut aider à contourner les problèmes de certificats TLS,
        // surtout dans les environnements de déploiement comme Vercel ou si le serveur SMTP utilise un certificat auto-signé.
        // À utiliser avec prudence en production (peut réduire légèrement la sécurité en cas de MITM sophistiquée, mais souvent nécessaire).
...
                    start: { 
                            ...
                            timeZone: 'Europe/Paris' // <<< AJOUT ICI pour le décalage horaire
                        },
                    end: { 
